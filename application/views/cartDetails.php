                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active dropdown">
                        ...
                        ?>
                            ...
                            <a class="nav-link" href="" style="color:#e4ff00;"><?php echo $_SESSION['username']; ?><span class="sr-only">(current)</span></a>
                        <?php
                        } else {
                        ?>
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="col-3 col-md-3 col-sm-12 ">
                            <div class="card-group">
                                <div class="card card-column" style="width: 18rem;    margin-bottom: 20px;">
                                    ...
                                    ?>
                                        <img class="card-img-top  " src='<?php echo base_url("$cart->image"); ?>' alt="" width="200" height="200">
